...
## Why squares become parallelograms

Start with:

- a square made from basis vectors  

After a linear transformation:

- the basis vectors point in new directions  
- the square formed by them becomes a **parallelogram**

Since the whole grid is built from these squares:

→ the **entire grid** becomes parallelogram-shaped

That’s why the book says:

> “Linear transformations map parallelepipeds to parallelepipeds.”
